...
<form method="post" action="{{ route('posts.store') }}">
    ...
    <div class="field">
        ...
        <div class="control">
            <input type="text" name="title" value="{{ old('title') }}" class="input" placeholder="Title" minlength="5" maxlength="190" required />
        </div>
    </div>
    ...
    <div class="field">
        ...
        <div class="control">
            <textarea name="content" class="textarea" placeholder="Content" minlength="5" maxlength="5000" required rows="10">{{ old('content') }}</textarea>
        </div>
    </div>
